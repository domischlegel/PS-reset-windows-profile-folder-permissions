...
$Folders = Get-ChildItem -Path $Pfad
...
$ACL.AddAccessRule((New-Object System.Security.AccessControl.FileSystemAccessRule("Administratoren", "FullControl", "ContainerInherit, ObjectInherit", "None", "Allow")))
